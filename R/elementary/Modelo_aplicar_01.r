...
#source("~/cloud/cloud1/R/inicial/Modelo_aplicar_01.r")
...
karchivo_generacion   <-  "M:\\datasets\\201902.txt"
karchivo_aplicacion   <-  "M:\\datasets\\201904.txt"
...
#estos son los parametros de un modelo bueno, no necesariamente el mejor modelo !
vxval       <-   0
vmaxdepth   <-  16
vminbucket  <-   6
vminsplit   <-  20 
...
noaciertos_marketing  <-  sum( data_pred[ , enviar*(1-positivo)] ) 
