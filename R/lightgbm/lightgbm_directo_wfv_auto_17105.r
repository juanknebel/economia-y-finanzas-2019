...
switch (Sys.info()[['sysname']],
         ...
         Linux   = { 
                     directory$work     <-  "~/cloud/cloud1/work/17105"
...
data$archivo_grande       <-  "paquete_premium_exthist_sinAVG_lm_original.txt.gz"  #aqui deberia usar el  _exthist  que tiene todos los campos creativos
env$data <- data
