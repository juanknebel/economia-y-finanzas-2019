...
dead_line = function(month_to_process) {
  ...
  # Experimento 17105, parametros que mejoraron la aplicacion del 201811
  # ventana=4, probcorte=0.237102812411219, num_iterations=38, learning_rate=0.236918437145218,
  # lambda_l1=1.10056967024715, lambda_l2=15.5882128592858, min_gain_to_split=11.6588293640635,
  # min_data_in_leaf=73, max_depth=19, feature_fraction=0.301110178945899, max_bin=255, subsample=1
...
file_name = "lightgbm_dead_line_1101"
from = 201806
to = 201904
