...
## modelitos 15
prob_modelitos_15_201806 = read_tsv("lightgbm_dead_line_modelitos15102_201806_probabilidades.txt") %>% mutate(foto_mes = 201806)
prob_modelitos_15_201807 = read_tsv("lightgbm_dead_line_modelitos15102_201807_probabilidades.txt") %>% mutate(foto_mes = 201807)
prob_modelitos_15_201808 = read_tsv("lightgbm_dead_line_modelitos15102_201808_probabilidades.txt") %>% mutate(foto_mes = 201808)
prob_modelitos_15_201809 = read_tsv("lightgbm_dead_line_modelitos15102_201809_probabilidades.txt") %>% mutate(foto_mes = 201809)
prob_modelitos_15_201810 = read_tsv("lightgbm_dead_line_modelitos15102_201810_probabilidades.txt") %>% mutate(foto_mes = 201810)
prob_modelitos_15_201811 = read_tsv("lightgbm_dead_line_modelitos15102_201811_probabilidades.txt") %>% mutate(foto_mes = 201811)
prob_modelitos_15_201812 = read_tsv("lightgbm_dead_line_modelitos15102_201812_probabilidades.txt") %>% mutate(foto_mes = 201812)
prob_modelitos_15_201901 = read_tsv("lightgbm_dead_line_modelitos15102_201901_probabilidades.txt") %>% mutate(foto_mes = 201901)
prob_modelitos_15_201902 = read_tsv("lightgbm_dead_line_modelitos15102_201902_probabilidades.txt") %>% mutate(foto_mes = 201902)
prob_modelitos_15_201903 = read_tsv("lightgbm_dead_line_modelitos15102_201903_probabilidades.txt") %>% mutate(foto_mes = 201903)
prob_modelitos_15_201904 = read_tsv("lightgbm_dead_line_modelitos15102_201904_probabilidades.txt") %>% mutate(foto_mes = 201904)
...
list_modelitos_15 = list(prob_modelitos_15_201806, prob_modelitos_15_201807, prob_modelitos_15_201808,
                         prob_modelitos_15_201809, prob_modelitos_15_201810, prob_modelitos_15_201811,
                         prob_modelitos_15_201812, prob_modelitos_15_201901, prob_modelitos_15_201902,
                         prob_modelitos_15_201903, prob_modelitos_15_201904)
...
setwd( "~/tmp/work/eco/")
file_profits = "ensamble_13_14_15_profit.csv"

for (a_cutoff in list_of_cutoff) {
  for (at_index in list_of_index) {
    prob_modelitos_15_index = list_modelitos_15[[at_index]]
    prob_modelitos_15_index = prob_modelitos_15_index %>% 
      rename(prob_positivo_modelitos_15 = prob_positivo)
    ...
    prob_all_index = prob_modelitos_index %>% 
      inner_join(prob_modelitos_15_index, by = c("numero_de_cliente", "foto_mes")) %>%
    ...
    prob_all_index = prob_all_index %>%
      select(-c(clase01.x.x, clase01.y.y, clase01.y)) %>%
      rename(clase01 = clase01.x) %>%
      mutate(prob_positivo = rowMeans(
        select(., prob_positivo_1007, prob_positivo_1008, prob_positivo_modelitos, prob_positivo_modelitos_15))) %>%
      select(-c(prob_positivo_1007, prob_positivo_1008, prob_positivo_modelitos, prob_positivo_modelitos_15))
...
setwd( "~/tmp/work/eco/probas")
file_presentation = "ensamble_15_entrega.txt"
prob_modelitos_15_201906 = read_tsv("lightgbm_dead_line_modelitos15102_201906_probabilidades.txt") %>% mutate(foto_mes = 201906)
...
prob_modelitos_15_201906 = prob_modelitos_15_201906 %>%
  rename(prob_positivo_modelitos_15 = prob_positivo)
...
prob_all_201906 = prob_1007_201906 %>% 
  ...
  inner_join(prob_modelitos_15_201906, by = c("numero_de_cliente", "foto_mes")) %>%
