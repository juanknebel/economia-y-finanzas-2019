...
data$archivo_grande       <-  "paquete_premium_exthist_lm_original.txt.gz"  #aqui deberia usar el  _exthist  que tiene todos los campos creativos
env$data <- data


#Parametros  mlrMBO   Optimizacion Bayesiana
mbo <- list()
mbo$iteraciones       <-  20   # cuantas iteraciones hace la Optimizacion Bayesiana
