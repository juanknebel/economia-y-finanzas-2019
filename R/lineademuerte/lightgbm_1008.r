...
dead_line = function(month_to_process) {
  ...
  # Experimento 17104, parametros que mejoraron la aplicacion del 201811
  # ventana=5, probcorte=0.219045182073366, num_iterations=80, learning_rate=0.0793095085924361,
  # lambda_l1=3.3965604699113, lambda_l2=11.3830685691552, min_gain_to_split=1.06019900662593,
  # min_data_in_leaf=19, max_depth=8, feature_fraction=0.589428906857636, max_bin=255, subsample=1
...
file_name = "lightgbm_dead_line_1008"
from = 201806
to = 201904
