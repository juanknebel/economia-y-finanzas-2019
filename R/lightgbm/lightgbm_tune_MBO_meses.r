...
modelo_lightgbm_valid = function( ptrain, x  )
{
  ...
  return( list("ganancia_test"=gan_validate, "auc_test"=auc_validate, "iteracion"=  iteracion_max) )
}
#------------------------------------------------------------------------------
...
modelo_lightgbm_puro = function( ptrain, x, piteracion  )
{
 ...
 # calculo el AUC
  ...
  return( list("ganancia_test"=gan_futuro, "auc_test"=auc_futuro) )
}
#------------------------------------------------------------------------------
...
obj.fun <- makeSingleObjectiveFunction(
        ...
        par.set = makeParamSet(
            makeNumericParam("pfeature_fraction"  ,  lower=0.2   , upper=   1.0),
            makeNumericParam("plearning_rate"     ,  lower=0.01  , upper=   0.3),
            makeIntegerParam("pmin_data_in_leaf"  ,  lower=1L    , upper= 100L),
            makeNumericParam("plambda_l1"         ,  lower=0.0   , upper=  20.0),
            makeNumericParam("plambda_l2"         ,  lower=0.0   , upper=  20.0),
